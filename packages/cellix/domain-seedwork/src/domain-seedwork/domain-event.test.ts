...
const feature = await loadFeature(path.resolve(__dirname, 'features/domain-event.feature'));
...
test.for(feature, ({ Scenario }) => {
	...
	Scenario('Accessing a payload on a Domain Event before it is set', ({ Given, When, Then }) => {
		Given('a new domain event', () => {
