...
export const create = (dataSources: DataSources) => async (command: TeamOperationCreateCommand): Promise<Domain.Contexts.Operations.TeamOperation.TeamOperationEntityReference> => {
