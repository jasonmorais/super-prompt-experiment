...
export class CourseRepository extends MongooseSeedwork.MongoRepositoryBase<CourseDocument, CourseDomainAdapter, Domain.Passport, Domain.Contexts.Learning.Course.Course<CourseDomainAdapter>> implements Domain.Contexts.Learning.Course.CourseRepository<CourseDomainAdapter> {
