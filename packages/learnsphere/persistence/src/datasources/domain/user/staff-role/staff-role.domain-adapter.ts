...
export class StaffRoleDomainAdapter extends MongooseSeedwork.MongooseDomainAdapter<StaffRoleDocument> implements Domain.Contexts.User.StaffRole.StaffRoleProps {
	...
	set roleName(value: string) {
		this.doc.roleName = value;
	}
	get enterpriseAppRole(): Domain.Contexts.User.StaffRole.StaffEnterpriseAppRole {
		return this.doc.enterpriseAppRole as Domain.Contexts.User.StaffRole.StaffEnterpriseAppRole;
	}
	set enterpriseAppRole(value: Domain.Contexts.User.StaffRole.StaffEnterpriseAppRole) {
		this.doc.enterpriseAppRole = value as typeof this.doc.enterpriseAppRole;
	}
	get isDefault() {
