...
export class LearnerUserRepository extends MongooseSeedwork.MongoRepositoryBase<LearnerUserDocument, LearnerUserDomainAdapter, Domain.Passport, Domain.Contexts.User.LearnerUser.LearnerUser<LearnerUserDomainAdapter>> implements Domain.Contexts.User.LearnerUser.LearnerUserRepository<LearnerUserDomainAdapter> {
