...
export class TeamOperationRepository extends MongooseSeedwork.MongoRepositoryBase<TeamOperationDocument, TeamOperationDomainAdapter, Domain.Passport, Domain.Contexts.Operations.TeamOperation.TeamOperation<TeamOperationDomainAdapter>> implements Domain.Contexts.Operations.TeamOperation.TeamOperationRepository<TeamOperationDomainAdapter> {
