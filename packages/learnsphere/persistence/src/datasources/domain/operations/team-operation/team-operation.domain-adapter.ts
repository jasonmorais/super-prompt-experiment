...
export class TeamOperationDomainAdapter extends MongooseSeedwork.MongooseDomainAdapter<TeamOperationDocument> implements Domain.Contexts.Operations.TeamOperation.TeamOperationProps {
	...
	set organizationId(v) { this.doc.organizationId = v; }
	get title() { return this.doc.title; }
	set title(v) { this.doc.title = v; }
	get description() { return this.doc.description; }
	set description(v) { this.doc.description = v; }
	get category() { return this.doc.category; }
	set category(v) { this.doc.category = v; }
	get priority() { return this.doc.priority; }
	set priority(v) { this.doc.priority = v; }
	get status() { return this.doc.status; }
	set status(v) { this.doc.status = v; }
	get assigneeId() { return this.doc.assigneeId; }
	set assigneeId(v) { this.doc.assigneeId = v; }
	get assigneeDisplayName() { return this.doc.assigneeDisplayName; }
	set assigneeDisplayName(v) { this.doc.assigneeDisplayName = v; }
	get assigneeEmail() { return this.doc.assigneeEmail; }
	set assigneeEmail(v) { this.doc.assigneeEmail = v; }
	get teamName() { return this.doc.teamName; }
	set teamName(v) { this.doc.teamName = v; }
	get createdBy() { return this.doc.createdBy; }
	set createdBy(v) { this.doc.createdBy = v; }
	get assignedAt() { return this.doc.assignedAt; }
	set assignedAt(v) { this.doc.assignedAt = v; }
	get dueAt() { return this.doc.dueAt; }
	set dueAt(v) { this.doc.dueAt = v; }
	get startedAt() { return this.doc.startedAt; }
	set startedAt(v) { this.doc.startedAt = v; }
	get submittedAt() { return this.doc.submittedAt; }
	set submittedAt(v) { this.doc.submittedAt = v; }
	get submittedBy() { return this.doc.submittedBy; }
	set submittedBy(v) { this.doc.submittedBy = v; }
	get completionNote() { return this.doc.completionNote; }
	set completionNote(v) { this.doc.completionNote = v; }
	get completionEvidence() { return this.doc.completionEvidence; }
	set completionEvidence(v) { this.doc.completionEvidence = v; }
	get confirmedAt() { return this.doc.confirmedAt; }
	set confirmedAt(v) { this.doc.confirmedAt = v; }
	get confirmedBy() { return this.doc.confirmedBy; }
	set confirmedBy(v) { this.doc.confirmedBy = v; }
