...
export interface StaffRoleUserPermissionsProps { canManageUsers: boolean; canAssignStaffRoles: boolean; canViewStaffUsers: boolean; }
export type StaffRoleUserPermissionsEntityReference = Readonly<StaffRoleUserPermissionsProps>;
export interface StaffRoleRolePermissionsProps { canViewRoles: boolean; canAddRole: boolean; canEditRole: boolean; canRemoveRole: boolean; }
export type StaffRoleRolePermissionsEntityReference = Readonly<StaffRoleRolePermissionsProps>;
export interface StaffRolePermissionsProps { staffPortalPermissions: StaffPortalPermissionsProps; userPermissions: StaffRoleUserPermissionsProps; staffRolePermissions: StaffRoleRolePermissionsProps; }
export interface StaffRolePermissionsEntityReference { readonly staffPortalPermissions: StaffPortalPermissionsEntityReference; readonly userPermissions: StaffRoleUserPermissionsEntityReference; readonly staffRolePermissions: StaffRoleRolePermissionsEntityReference; }
...
class PermissionGroup<T extends object> {
	...
	constructor(props: T, visa: UserVisa) { this.props = props; this.visa = visa; }
...
export class StaffPortalPermissions extends PermissionGroup<StaffPortalPermissionsProps> implements StaffPortalPermissionsEntityReference {
	get canViewTeamLearning() { return this.get('canViewTeamLearning'); } set canViewTeamLearning(v) { this.set('canViewTeamLearning', v); }
	get canManageCourses() { return this.get('canManageCourses'); } set canManageCourses(v) { this.set('canManageCourses', v); }
	get canPublishCourses() { return this.get('canPublishCourses'); } set canPublishCourses(v) { this.set('canPublishCourses', v); }
	get canDeleteCourses() { return this.get('canDeleteCourses'); } set canDeleteCourses(v) { this.set('canDeleteCourses', v); }
...
export class StaffRoleUserPermissions extends PermissionGroup<StaffRoleUserPermissionsProps> implements StaffRoleUserPermissionsEntityReference {
	...
	get canAssignStaffRoles() { return this.get('canAssignStaffRoles'); } set canAssignStaffRoles(v) { this.set('canAssignStaffRoles', v); }
	get canViewStaffUsers() { return this.get('canViewStaffUsers'); } set canViewStaffUsers(v) { this.set('canViewStaffUsers', v); }
}
export class StaffRoleRolePermissions extends PermissionGroup<StaffRoleRolePermissionsProps> implements StaffRoleRolePermissionsEntityReference {
	get canViewRoles() { return this.get('canViewRoles'); } set canViewRoles(v) { this.set('canViewRoles', v); }
	get canAddRole() { return this.get('canAddRole'); } set canAddRole(v) { this.set('canAddRole', v); }
	get canEditRole() { return this.get('canEditRole'); } set canEditRole(v) { this.set('canEditRole', v); }
	get canRemoveRole() { return this.get('canRemoveRole'); } set canRemoveRole(v) { this.set('canRemoveRole', v); }
}
export class StaffRolePermissions implements StaffRolePermissionsEntityReference {
	...
	private readonly visa: UserVisa;
	constructor(props: StaffRolePermissionsProps, visa: UserVisa) { this.props = props; this.visa = visa; }
	get staffPortalPermissions() { return new StaffPortalPermissions(this.props.staffPortalPermissions, this.visa); }
	get userPermissions() { return new StaffRoleUserPermissions(this.props.userPermissions, this.visa); }
	get staffRolePermissions() { return new StaffRoleRolePermissions(this.props.staffRolePermissions, this.visa); }
}
...
export class StaffRole<props extends StaffRoleProps = StaffRoleProps> extends AggregateRoot<props, Passport> implements StaffRoleEntityReference {
	private isNew = false;
	private readonly visa: UserVisa;
	constructor(props: props, passport: Passport) { super(props, passport); this.visa = passport.user.forStaffRole(this); }
	static getNewInstance<props extends StaffRoleProps>(newProps: props, passport: Passport, roleName: string, isDefault = false): StaffRole<props> {
		const role = new StaffRole(newProps, passport); role.isNew = true; role.roleName = roleName; role.isDefault = isDefault; role.isNew = false; return role;
	}
	...
	set roleName(value: string) { this.validateManagement(); this.props.roleName = value.trim(); }
	get enterpriseAppRole() { return this.props.enterpriseAppRole; }
	...
	set isDefault(value: boolean) { this.validateManagement(); this.props.isDefault = value; }
	get permissions() { return new StaffRolePermissions(this.props.permissions, this.visa); }
	updatePermissions(value: Partial<{ [K in keyof StaffRolePermissionsProps]: Partial<StaffRolePermissionsProps[K]> }>): void {
		this.validateManagement();
		const permissions = { staffPortalPermissions: { ...this.props.permissions.staffPortalPermissions, ...(value.staffPortalPermissions ?? {}) }, userPermissions: { ...this.props.permissions.userPermissions, ...(value.userPermissions ?? {}) }, staffRolePermissions: { ...this.props.permissions.staffRolePermissions, ...(value.staffRolePermissions ?? {}) } };
	...
	get roleType() { return this.props.roleType; }
