...
export const mongooseContextBuilder = (initializedService: MongooseSeedwork.MongooseContextFactory) => {
	...
	return { Course: CourseModelFactory(initializedService), LearningRecord: LearningRecordModelFactory(initializedService), TeamOperation: TeamOperationModelFactory(initializedService) } as const;
};
