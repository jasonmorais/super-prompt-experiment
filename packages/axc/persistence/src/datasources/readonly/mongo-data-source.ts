...
/**
 * Read-model data source over a Mongoose model. Ported from the Cellix
 * `readonly/mongo-data-source.ts`: returns lean documents with a string `id`
 * derived from `_id`, and supports projection, population, sorting, and
 * aggregation. Read repositories build on top of this.
 */
