...
export const oidcConfig: OIDCConfig = {
	authority: import.meta.env.VITE_APP_UI_PORTAL_AUTHORITY ?? 'https://mock-auth.agentcourses.localhost:1355/portal',
	client_id: import.meta.env.VITE_APP_UI_PORTAL_CLIENTID ?? 'mock-client',
	redirect_uri: import.meta.env.VITE_APP_UI_PORTAL_REDIRECT_URI ?? 'https://agentcourses.localhost:1355/auth-redirect',
	response_type: 'code',
